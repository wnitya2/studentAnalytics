...
public class ResultCreditTransferredGroupModel extends GroupsModelArray<Transcript, String, String, Object>{

	private static final long serialVersionUID = 1L;
	
	private boolean showGroup;	
	
	public ResultCreditTransferredGroupModel(List<Transcript> data, Comparator<Transcript> cmpr, boolean showGroup) {
    ...
    protected String createGroupFoot(Transcript[] groupdata, int index, int col) {    	
    	...
    	sb.append("Total credits transferred: ").append(String.valueOf(totalCredit));    	
    	return sb.toString();
    }  
